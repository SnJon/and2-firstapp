    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun numberDisplay(number: Int): String {
            ...
            return when {
                ...
                (number in 1000..9999 && (((number / 100) % 10) != 0)) -> ((kotlin.math.floor(number.toFloat() / 1000F * 10F)) / 10F).toString() + "K"
                (number in 10000..999999) -> (number / 1000).toString() + "K"
                ((number > 999_999) && (((number / 100_000) % 10) == 0)) -> (number / 1_000_000).toString() + "M"
                ((number > 999_999) && (((number / 100_000) % 10) != 0)) -> ((kotlin.math.floor(
                    number.toFloat() / 1_000_000F * 10F
                )) / 10F).toString() + "M"
